...
class MangoCard {
  ...
  @override
  int get hashCode {
    return cardNumber.hashCode ^ expirationDate.hashCode ^ cvx.hashCode ^ cardType.hashCode;
  }
  ...
  factory MangoCard.fromJson(String source) => MangoCard.fromMap(json.decode(source));
}
